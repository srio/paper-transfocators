...
The propagation uses 2D propagators and optical elements available in Wofry. Results are shown in Fig.~\ref{fig:comsyl}. This figure shows results very similar to Fig.~\ref{fig:2DWofry1D}, which is reasonable because the physical models used for the CMD and propagation are similar. The beam profiles calculated with COMSYL have more noise because the 2D wavefront sampling cannot be as high as in Wofry within a reasonable CPU usage. The full calculation with COMSYL helped to validate for the studied beamline the underlying approximation in the one-dimensional CMD introduced in this work.
...
% \todo{This discrepancy can be originated by... THINK ABOUT THAT...}.
